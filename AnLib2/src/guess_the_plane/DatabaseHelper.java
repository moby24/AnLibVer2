...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	private static final String DATABASE_CREATE_SCRIPT = "create table "
			+ DATABASE_TABLE + " (_id integer primary key autoincrement, " +SCORE_NAME_COLUMN+ " integer);";
	private static final String DATABASE_INSERT_SCRIPT = "INSERT INTO game VALUES ('1','0'); ";
